...
export HADOOP_ROOT_LOGGER=INFO,console;$HADOOP_PATH/bin/hadoop jar $HADOOP_PATH/share/hadoop/yarn/hadoop_demos-1.0.jar com.jorgefigueiredo.demos.hadoop.jobs.TopNWordsMRJob --jar $HADOOP_PATH/share/hadoop/yarn/hadoop_demos-1.0.jar --shell_command date --num_containers 1 
