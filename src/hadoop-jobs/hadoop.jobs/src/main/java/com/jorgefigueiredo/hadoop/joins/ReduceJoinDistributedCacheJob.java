...
public class ReduceJoinDistributedCacheJob extends Configured implements Tool {

	public static void main(String[] args) throws Exception {

        int res = ToolRunner.run(new Configuration(), new ReduceJoinDistributedCacheJob(), args);
        System.exit(res);
	}
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(ReduceJoinDistributedCacheJob.class);
